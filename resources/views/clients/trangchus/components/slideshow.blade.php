<div class="slide-home-01">
    <div class="container">
      <div
        ...
        data-slick='{"arrows":{{$slideShow[0]->arrows==1 ? 'true' : 'false'}},"slidesMargin":0,"dots":{{$slideShow[0]->dots==1 ? 'true' : 'false'}},"infinite":{{$slideShow[0]->infinite==1 ? 'true' : 'false'}},"speed":{{$slideShow[0]->speed}},"slidesToShow":1,"rows":1}'
